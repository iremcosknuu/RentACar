...
public class CorporateCustomerManager implements CorporateCustomerService{
	...
	public DataResult<CorporateCustomerListDto> findById(int id) {
		if(this.corporateCustomerDao.existsById(id)) {
			CorporateCustomer corporateCustomerList = this.corporateCustomerDao.findById(id).get();
			CorporateCustomerListDto response = modelMapperService.forDto().map(corporateCustomerList, CorporateCustomerListDto.class);
			return new SuccessDataResult<CorporateCustomerListDto>(response);
		}
		return new ErrorDataResult<CorporateCustomerListDto>();
	}
