...
public class Messages {
	...
	public static final String corporateCustomerIdNotExists="corporateCustomer.id.not.exists";
	...
	public static final String findexScoreIsNotEnough="findexScore.not.enough";
	public static final String customerAgeNotEnough="customer.age.not.enough";
	public static final String invoiceAdded = "invoice.added";
	public static final String invoiceRentalIsAlreadyExist="invoice.rental.is.already.exists";
